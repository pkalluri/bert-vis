...
parser.add_argument('data_dir', help='Directory containing input standard acts file.')
parser.add_argument('out_data_dir', help='Directory in which to put output spherized acts file.')
